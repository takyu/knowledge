...
// import shader
import vertShaderSource from '@shader/02_webgl/090_glsl_vector_swizzle/vertex.glsl';
import fragShaderSource from '@shader/02_webgl/090_glsl_vector_swizzle/fragment.glsl';
