...
// import shader
import vertShaderSource from '@shader/02_webgl/150_glsl_mix_step/vertex.glsl';
import fragShaderSource from '@shader/02_webgl/150_glsl_mix_step/fragment.glsl';
